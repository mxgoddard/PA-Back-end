...
const { getEventById, patchHandledEvent, getHandledEvents, getUnhandledEvents } = require('../controllers/event');
...
router
  .route('/handledEvents')
  .get(getHandledEvents);

router
  .route('/unhandledEvents')
  .get(getUnhandledEvents);
